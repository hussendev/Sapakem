...
import 'package:sapakem/screens/btn/order_screens/order_details_screens.dart';
...
class OrderList extends StatelessWidget {
  ...
  const OrderList({Key? key, required this.order, this.withoutOrderDetails = false, this.ordersDetails}) : super(key: key);
      ...
      child: Stack(
        children: [
          Container(
            ...
            margin: EdgeInsets.symmetric(horizontal: ordersDetails != null ? 10.w : 35.w, vertical: 41.h),
            padding: EdgeInsets.symmetric(horizontal: ordersDetails != null ? 20.w : 45.w),
            child: Column(
              children: [
                58.ph(),
                Row(
                ...
                if (ordersDetails != null)
                  for (int i = 0; i < ordersDetails!.length; i++)
                    Column(
                      children: [
                        ItemOrder(order: ordersDetails![i]),
                        Divider(
                          color: Colors.grey.shade300,
                          thickness: 1,
                        ),
