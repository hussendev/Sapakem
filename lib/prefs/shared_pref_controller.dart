...
enum PrefKeys { language, id, mobile, active, verified, email, name, loggedIn, token, fcmToken, deviceType, lat, lng, otp, cityName, image, seen }
...
class SharedPrefController {
  ...
  void save(User user) {
    ...
    _sharedPreferences.setString(PrefKeys.cityName.name, user.userData!.cityName!);
  ...
  void updateProfile({required String name, required String email, required String mobile, String? imageUrl}) {
    _sharedPreferences.setString(PrefKeys.name.name, name);
    _sharedPreferences.setString(PrefKeys.email.name, email);
    _sharedPreferences.setString(PrefKeys.mobile.name, mobile);
    if (imageUrl != null) _sharedPreferences.setString(PrefKeys.image.name, imageUrl);
  }
}
