                    ...
                    builder: (context, state2) {
                      if (state2 is OrdersLoading) {
                        ...
                        return Visibility(
                          ...
                          /// my current requests
                          replacement: state2.orders['current']!.isNotEmpty
                              ? Column(
                                  children: [
                                    for (int i = 0;
                                        i < state2.orders['current']!.length;
                                        i++)
                                      if (int.parse(state2
                                              .orders['current']![i].status!) <=
                                          3)
                                        Column(
                                          children: [
                                            CurrentRequestsWidget(
                                                orderStatus: int.parse(state2
                                                        .orders['current']![i]
                                                        .status!) -
                                                    1),
                                            Padding(
                                            ...
                                            Padding(
                                              ...
                                              child: ListTile(
                                                ...
                                                subtitle: AppText(
                                                  text:
                                                      '${state2.orders['current']![i].hour!}  ${state2.orders['current']![i].createdAt!}',
                                                  fontSize: 14.sp,
                                                  color: Colors.black,
                                                ),
                                              ),
                          ...
                          child: Column(
                            children: [
                              for (int i = 0;
                                  i < state2.orders['previous']!.length;
                                  i++)
                                OrderList(order: state2.orders['previous']![i]),
